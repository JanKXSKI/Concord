...
public:
    ...
    TSharedPtr<FUICommandInfo> ExportTikz;
...
#define LOCTEXT_NAMESPACE "ConcordModelEditorCommands"
        ...
        UI_COMMAND(ExportTikz, "Export TikZ", "Exports a .tikz file describing the model graph.", EUserInterfaceActionType::Button, FInputChord());
